                                ...
                                <div class="overflow-x-auto">
                                    <table class="min-w-full text-left text-sm font-light">
                                        ...
                                        <tr class="border-b dark:border-neutral-500" v-for="attendance in attendances.data" :key="attendance.id">
                                            <td scope="col"  class="whitespace-nowrap px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">{{ attendance.attendancedate }}</td>
                                            <td scope="col"  class="whitespace-nowrap px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">
                                                
                                            </td>
                                            <td scope="col"  class="whitespace-nowrap px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">{{ attendance.group_id }}</td>
                                            <td scope="col"  class="whitespace-nowrap px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100"></td>
                                            <td scope="col"  class="whitespace-nowrap px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100"></td>
                                            <td scope="col"  class="whitespace-nowrap px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100"></td>
                                            <td scope="col"  class="whitespace-nowrap px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100"></td>
                                        </tr>
