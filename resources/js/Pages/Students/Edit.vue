                       ...
                       <section class="text-gray-600 body-font relative">
                        ...
                        <div class="container px-5 py-8 mx-auto">
                            ...
                            <div class="flex flex-wrap -m-2">
                                ...
                                <div class="relative">
                                    <label for="groupname" class="leading-7 text-sm text-gray-600">所属クラス</label>
                                    <div v-for="(group, index) in student.groups" :key="index">
                                    <select class="w-1/2 mb-2 bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                        <option>{{ group.name }}</option>
                                    </select>
                                    <button class="btn btn-outline-danger ml-4 bg-red-400 text-white px-2 rounded text-sm" @click="deleteForm(index)">削除</button>
                                    </div>
                                </div>
                                </div>
